class UserPhotosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_photo.save
        ...
        format.json { render :show, status: :created, location: @user_photo }
      else
  ...
  def update
    respond_to do |format|
      if @user_photo.update(user_photo_params)
        ...
        format.json { render :show, status: :ok, location: @user_photo }
      else
  ...
  def destroy
    @user_photo.destroy
    respond_to do |format|
      format.html { redirect_to user_photos_url, notice: 'User photo was successfully destroyed.' }
