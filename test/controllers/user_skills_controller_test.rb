...
class UserSkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_skill" do
    assert_difference('UserSkill.count') do
      post user_skills_url, params: { user_skill: { UserField_id: @user_skill.UserField_id, skill_id: @user_skill.skill_id } }
    end
  ...
  test "should update user_skill" do
    patch user_skill_url(@user_skill), params: { user_skill: { UserField_id: @user_skill.UserField_id, skill_id: @user_skill.skill_id } }
