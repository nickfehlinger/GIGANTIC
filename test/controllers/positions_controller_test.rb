...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { admin: @position.admin, company_id: @position.company_id, name: @position.name } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { admin: @position.admin, company_id: @position.company_id, name: @position.name } }
